...
// Middleware
app.use(cors());
app.use(bodyParser.json({ limit: '50mb' })); // Increased limit for canvas images
app.use(bodyParser.urlencoded({ extended: true, limit: '50mb' })); // Increased limit for canvas images
